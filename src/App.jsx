...
const COMPANY_NAME = "Aloha Technology Solutions";
      ...
      <div className="relative grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-8">
          <div className="space-y-5">
            ...
            <p className="max-w-2xl text-lg leading-8 text-slate-200">Locally owned and operated on the Big Island, Aloha Technology Solutions helps businesses, homeowners, and property managers build websites, implement automation and AI, improve operations, modernize technology, coordinate trusted vendors, and complete projects with confidence.</p>
          </div>
...
export default function TechnicalSolutionsCompanyWebsite() {
  ...
  return <div className="min-h-screen bg-white text-slate-900">
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur"><div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:px-8"><button onClick={() => openPage("home")} className="text-left"><div className="text-xl font-bold tracking-tight text-[#17324D]">{COMPANY_NAME}</div><div className="text-sm text-slate-500">Technology • Digital • Property • Operations</div></button>
