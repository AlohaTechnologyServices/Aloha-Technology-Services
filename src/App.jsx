  ...
  return (
    <div className="space-y-16">
      ...
      <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="p-7 md:p-9"><h2 className="text-3xl font-bold text-[#061B33]">Local roots. Hands-on experience. Operational leadership.</h2><div className="mt-5 space-y-4 leading-8 text-slate-600"><p>I grew up in Waimea, graduated from Parker School, and earned a Bachelor’s Degree in Physics from the University of Hawaiʻi at Mānoa before returning home to build my career.</p><p>My professional background gives me a broad, practical understanding of how properties, building systems, vendors, technology, and day-to-day operations work together. I built that perspective through hands-on experience with electrical work, irrigation, landscaping, flooring, and detailed finish work, then carried it into my professional role as a Luxury Residential Operations Manager, where I was responsible for the readiness, care, coordination, and day-to-day performance of high-value residences. That combination allows me to approach every ATS service with both technical awareness and an operator’s perspective—paying close attention to workmanship, condition, documentation, communication, and the details that determine whether a job is truly completed to a high standard.</p><p>Throughout my career, I have supported more than 50 high-value residences, coordinated with more than 60 local vendors, and helped manage thousands of guest arrivals and departures. I have also developed inspection standards, SOPs, training materials, damage-tracking systems, and operational tools. Those experiences taught me to work systematically, verify details, anticipate problems, communicate clearly, and follow through. I bring those same standards to every ATS service, with the goal of delivering work that is thorough, dependable, well documented, and completed at the highest level of quality I can provide.</p></div></Card>
